...
function checkRole(){
	if(MangForm.Role.value==("a")){
		return true;
		}else{
			window.alert("you can not manage user account");
			return false;
		}
}
...
<H1 bgcolor=#0000ff><CENTER>Welcome Administrator</CENTER></H1>
<BR>
<BR>
<BR>
<BR>
...
<%
//We use this page as the Administrator login successfully page
	...
	if(request.getParameter("user") != null){
	    ...
	    String driverName = "oracle.jdbc.driver.OracleDriver";
        	...
        	//get personal information from person table to let user see if they want to modify some of them
        	try{
...
<FORM NAME="MangForm" ACTION="adminManag.jsp" METHOD="post" >
<%
	out.println("<input TYPE ='hidden' name='Role' value ='"+role+"' >");
%>
<INPUT TYPE="submit"NAME="Reset" VALUE="Managnment" ONCLICK="return checkRole();">

</FORM>

<FORM NAME="AnaForm" ACTION="dataAnaly.jsp" METHOD="post" >

<INPUT TYPE="submit"NAME="Reset" VALUE="Analysis" >

</FORM>
<FORM NAME="DocForm" ACTION="search_ad.jsp"+userName METHOD="post">
